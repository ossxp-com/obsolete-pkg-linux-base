...
############################################################
PKG_LIST='''
	rpm-build, rpm-devel, rpmdevtools, rpm-python, quilt, doxygen, 
	gcc, gdb, gcc-c++, make, patch, autoconf, automake, chrpath,
	java-1.6.0-openjdk, fakeroot, module-init-tools, 
	libtool, glibc, ncurses-devel,
	openssl-devel, openldap-devel, libxml2-devel, expat-devel, mod_perl-devel, bzip2-devel, 
	libc-client-devel, curl-devel, freetype-devel, libgcrypt-devel,
	libjpeg-devel, libmcrypt-devel, mhash-devel, mysql-devel, libpng-dev,
	pkgconfig, junit, ant,
	python-dev, python-babel, python-setuptools,
	ruby, ruby-devel, rubygems,
	mkisofs,
	patchutils, qemu, swig,
	uuid-devel,
	git-all, mercurial, 
	'''
############################################################
