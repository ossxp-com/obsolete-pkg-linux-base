...
############################################################
PKG_LIST='''
	acl, autofs, bridge-utils, bzip2,
	curl, cabextract, coreutils | shellutils,
	dstat, ethtool, file, fping, fuse,
	git-core | git, gnupg, htop, ia32-libs, ia32-libs-gtk, indent, iproute,
	less, lynx, redhat-lsb, make, ntfs-3g, ntp, nmap,
	openssl, gnutls-utils, p7zip, p7zip-plugins, pciutils, perl, psmisc,
	gistore | etckeeper | rdiff-backup, rsync, unrar, byobu | screen,
